<div class="page-sidebar-wrapper">
    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <!-- DOpage-sidebar-wrapperC: Set data-auto-speed="200" to adjust the sub menu slide up/down speed -->
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item  ">
                        <a href="{{ route('flight') }}" class="nav-link ">
                            <span class="title">All Flight</span>
                        </a>
                    </li>
                    <li class="nav-item  ">
                        <a href="{{ route('addflight') }}" class="nav-link ">
                            <span class="title">Add Flight</span>
                        </a>
                    </li>
                    <li class="nav-item  ">
                        <a href="ui_general.html" class="nav-link ">
                            <span class="title">Booking Flight</span>
                        </a>
                    </li>
                    <li class="nav-item  ">
                        <a href="{{ route('allairport') }}" class="nav-link ">
                            <span class="title">All Airport</span>
                        </a>
                    </li>
                    <li class="nav-item  ">
                        <a href="{{ route('addairport') }}" class="nav-link ">
                            <span class="title">Add Airport</span>
                        </a>
                    </li>
                    <li class="nav-item  ">
                        <a href="{{ route('allcompany') }}" class="nav-link ">
                            <span class="title">Company of flight</span>
                        </a>
                    </li>
